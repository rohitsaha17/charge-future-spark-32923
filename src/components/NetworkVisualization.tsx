          ...
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                {/* Node */}
                <div 
                  className={`relative transition-all duration-300 ${isActive ? 'scale-125' : 'scale-100'}`}
                >
                  {/* Glow effect */}
                  <div 
                    className={`absolute inset-0 rounded-full blur-xl transition-opacity duration-300 ${isActive ? 'opacity-60' : 'opacity-0'}`}
                  ...
                  <div 
                    ...
                    style={{ 
                      ...
                      boxShadow: isActive ? `0 0 30px ${feature.color}60` : 'none'
                    }}
                  >
